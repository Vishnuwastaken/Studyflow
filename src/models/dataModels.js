...
export const createDefaultState = () => ({
  ...
  pet:{ name:'Pebble', level:1, xp:0, mood:'calm', lastMoodAt:Date.now(), inventory:[], equipped:{hat:null,face:null,color:null} },
